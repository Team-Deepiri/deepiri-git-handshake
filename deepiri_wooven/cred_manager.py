...
def register_git_credential_helper() -> tuple[bool, str]:
    ...
    return True, f"Added credential.helper={HELPER_NAME} (runs git-credential-wooven from PATH)."
...
def unregister_git_credential_helper() -> tuple[bool, str]:
    ...
    return True, f"Removed credential.helper entries and re-registered {len(rest)} helper(s) (wooven dropped)."
