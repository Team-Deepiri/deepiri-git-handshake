"""Git credential helper: git-credential-wooven — reads HTTPS PAT from OS keyring."""

from __future__ import annotations

import sys

from deepiri_wooven.cred_manager import get_pat, https_username_for
...
def run_git_credential(op: str) -> int:
    ...
    if op == "store":
        ...
        if password and host:
            from deepiri_wooven.cred_manager import store_pat, upsert_profile
    ...
    if op == "erase":
        from deepiri_wooven.cred_manager import clear_pat
